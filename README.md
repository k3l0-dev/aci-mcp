...
The server exposes a small set of generic tools. Documentation and usage examples are in [`mcp/client/SKILL.md`](mcp/client/SKILL.md) and [`docs/tools/`](docs/tools/).
